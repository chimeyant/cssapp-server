...
export default class AppInfosController {
  public async index({}: HttpContextContract) {
    ...
    data['app_logo_path']= Env.get("NODE_ENV")=='development' ? Env.get("BASE_URL")+ await Drive.getUrl("images/apps/" + appinfo?.app_logo) : Env.get("BASE_URL")+ await Drive.getSignedUrl('images/apps/'+ appinfo?.app_logo)
    data['app_theme']= appinfo?.app_theme
    data['app_color']=appinfo?.app_color
    data['app_background']= appinfo?.app_background
    data['app_background_path']= Env.get("NODE_ENV")== 'development'?  Env.get("BASE_URL")+ "/images/apps/"+ appinfo?.app_background : Env.get("BASE_URL") + await Drive.getUrl("images/apps/"+ appinfo?.app_background)
