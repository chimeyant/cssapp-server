...
export default class AppsController {
  async index({}:HttpContextContract){
    ...
    const logourl = await Drive.getUrl("images/apps/"+ appinfo?.app_logo)
    ...
    if(authent == 'superadmin'){
      menus = [
        ...
        },
        {
          ...
          route: "/backend/master-lokasi",
          type: "item",
        },
        {
          title: "Hotel",
          icon: "mdi-office-building-marker-outline",
          route: "/backend/master-hotel",
          type: "item",
        },
        {
          title: "Daerah Wisata",
          icon: "mdi-heart-circle-outline",
          route: "/backend/master-wisata",
          type: "item",
        },
        {
          title: "Daftar LO",
          icon: "mdi-account-tie-voice",
          route: "/backend/master-lo",
          type: "item",
        },
        ...
        },
        {
          title: "Gallery Foto",
          icon: "mdi-panorama",
          route: "/backend/halaman-depan-foto",
          type: "item",
        },{
          title: "Gallery Video",
          icon: "mdi-video",
          ...
          route:"/backend/halaman-depan-document",
          type:"item"
        },
